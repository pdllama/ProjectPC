...
export default function Features({smScreen}) {
    const theme = useTheme()

    const orientation = smScreen ? {...theme.components.box.fullCenterCol, justifyContent: 'start'} : {...theme.components.box.fullCenterRow, alignItems: 'start'}

    return (
        <Box sx={{width: '100%', backgroundColor: theme.palette.color1.dark, color: theme.palette.color3.main, ...theme.components.box.fullCenterCol}}>
            <Box sx={{height: '10%', my: 2, ...theme.components.box.fullCenterRow}}>
                <Typography variant='h5' sx={{fontSize: smScreen ? '36px' : '24px', fontWeight: 700}}>Features</Typography>
            </Box>
            <Box sx={{height: '90%', width: '96%', mb: 2, ...theme.components.box.fullCenterCol, gap: 2}}>
                <Box sx={{width: '100%', height: '50%', ...orientation}}>
                    <Box sx={{width: smScreen ? '100%' : '50%', height: '100%', ...theme.components.box.fullCenterCol, justifyContent: 'start', maxWidth: smScreen ? '100%' : '400px', mr: smScreen ? 0 : 3}}>
                    ...
                    <Box sx={{width: smScreen ? '100%' : '50%', height: '100%', ...theme.components.box.fullCenterCol, justifyContent: 'start', maxWidth: smScreen ? '100%' : '400px', ml: smScreen ? 0 : 3}}>
